...
abstract class FieldListState extends ScreenBlocState {
  ...
  FieldListState(bool isLoading, this.fields, this.originalFields)
      : super(isLoading);
...
class FieldsFilterState extends FieldListState {
  FieldsFilterState(List<Field> filterFields, List<Field> fields)
      : super(false, filterFields, fields);
}
